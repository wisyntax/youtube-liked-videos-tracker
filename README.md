...
1. **Go to your YouTube activity page**. Navigate to your [YouTube Likes and Dislikes Activity Page](https://myactivity.google.com/page?page=youtube_likes).

2. **Auto-scroll your activity** to load all your liked videos. Open your browser console (`F12` → Console tab) and paste this script:
...
3. **Extract your likes as CSV**. Once scrolling completes, paste this script to generate and download your data file:
   - This creates `youtube_activity_YYYY-MM-DD.csv` containing all your activity data in a format the script can import
...
4. **Import into the script**. 
   - Click the heart menu button in the bottom-right corner
   - Click **Options** to open the submenu
...
3. When prompted, enter the max number of videos to scan:
   - **First time (no existing likes)**: Leave blank to scan all videos
   - **Already have likes**: Leave blank to scan only loaded videos
...
- 💔 **Clear liked index** - Clear all videos from script index
